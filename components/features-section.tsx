        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="relative bg-white rounded-3xl border border-[#D9D2BE] shadow-xl shadow-[#1F3842]/5 p-8">
