...
export function LegalHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#D9D2BE]/30">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-full hover:bg-[#7EA088] hover:text-white transition-colors group/lang"
            title={locale === "en" ? "Cambiar a Español" : "Switch to English"}
          >
            <Globe className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#4D6E7B] group-hover/lang:text-white transition-colors" />
          ...
          <a
            href="/"
            className="hidden sm:flex items-center gap-2 border border-[#D4A24D] rounded-full px-5 py-2.5 overflow-hidden group/btn transition-all duration-300 hover:shadow-[0_0_16px_rgba(212,162,77,0.4)] relative no-underline"
          >
            ...
            <span className="text-sm font-medium text-[#D4A24D] group-hover/btn:text-white relative z-10 transition-colors duration-300">
